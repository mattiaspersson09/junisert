 ...
 * Also used to mark a supported internal type's implemented value, to prevent facing
 * {@link ClassCastException} and narrowing conversion during value lookup from a {@link ValueGenerator}.
 *
...
final class Implementation<T> implements Value<T>, Sortable {
     ...
     */
    boolean isImplementationOf(Class<?> origin) {
        if (origin == null) {
            return false;
        }
