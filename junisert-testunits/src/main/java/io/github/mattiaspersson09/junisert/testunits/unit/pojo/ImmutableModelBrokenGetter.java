...
public final class ImmutableModelBrokenGetter {
    private final long longField;
    private final String stringField;
    private final boolean booleanField;

    public ImmutableModelBrokenGetter(long longField, String stringField, boolean booleanField) {
    ...
    public boolean equals(Object object) {
        ...
        ImmutableModelBrokenGetter that = (ImmutableModelBrokenGetter) object;
