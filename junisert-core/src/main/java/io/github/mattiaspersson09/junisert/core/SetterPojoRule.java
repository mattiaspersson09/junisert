...
public class SetterPojoRule {
//    private static final Logger LOGGER = Logger.getLogger(SetterPojoRule.class);
//
//    private final ValueService valueService;
//
//    public SetterPojoRule(ValueService valueService) {
//        this.valueService = valueService;
//    }
//
//    public void enforce(Unit unit) {
...
////          LOGGER.info(unit.getName() + " has setter '" + method.getName() + "' for field '" + field.getName() + "'");
...
//
//            if (!hasSetter) {
//                throw new SetterAssertionError(unit.getName() + " is missing setter for field: " + field.getName());
//            }
//        }
//    }
//
//    private boolean isSettingValueForFieldInPojo(UnitMethod setter, Field field) {
    ////    try {
